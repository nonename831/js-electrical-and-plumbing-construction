...
const BASE = '/js-electrical-and-plumbing-construction/assets/images';

const IMAGES: GalleryImage[] = [
  { src: `${BASE}/electrical-1.png`, category: 'electrical', captionZh: '安装配电箱', captionEn: 'DB Box Installation' },
  { src: `${BASE}/electrical-2.png`, category: 'electrical', captionZh: '安装插头', captionEn: 'Socket Installation' },
  { src: `${BASE}/electrical-3.png`, category: 'electrical', captionZh: '安装灯具', captionEn: 'Light Fixture Installation', objectPosition: 'top' },
  { src: `${BASE}/electrical-4.png`, category: 'electrical', captionZh: '安装风扇', captionEn: 'Ceiling Fan Installation' },
  { src: `${BASE}/plumbing-1.png`, category: 'plumbing', captionZh: '安装热水器', captionEn: 'Water Heater Installation', objectPosition: '50% 20%' },
  { src: `${BASE}/plumbing-2.png`, category: 'plumbing', captionZh: '水管维修', captionEn: 'Pipe Repair', objectPosition: '50% 10%' },
  { src: `${BASE}/plumbing-3.png`, category: 'plumbing', captionZh: '安装马桶', captionEn: 'Toilet Installation', objectPosition: 'top' },
  { src: `${BASE}/plumbing-4.png`, category: 'plumbing', captionZh: '安装洗手盆', captionEn: 'Basin Installation', objectPosition: 'top' },
];
