        ...
        <div className="p-8 md:p-12">
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            <div className="flex flex-col items-center text-center p-6 bg-gray-50 rounded-xl">
              ...
              <a href={`tel:${CONTACT_INFO.phone.replace(/\s/g, '')}`} className="text-brand-blue font-semibold text-lg hover:underline">
                {CONTACT_INFO.phone}
              </a>
            </div>
          ...
          <div className="text-center">
            <a
              ...
              className="group inline-flex items-center justify-center gap-3 bg-brand-green text-white px-8 py-4 rounded-full text-lg font-bold shadow-lg hover:bg-brand-greenHover hover:shadow-xl hover:-translate-y-1 transition-all duration-300 w-full md:w-auto"
            >
